//
//  NSObject+WXMAPKeyValue.m
//  Pods
//
//  Created by yangshengtao on 17/3/1.
//
//

#import "NSObject+WXMAPKeyValue.h"

@implementation NSObject (WXMAPKeyValue)

#pragma mark - 模型 -> 字典
/*
- (NSMutableDictionary *)wx_keyValues
{
    return [self wx_keyValuesWithKeys:nil ignoredKeys:nil];
}

- (NSMutableDictionary *)wx_keyValuesWithKeys:(NSArray *)keys ignoredKeys:(NSArray *)ignoredKeys
{
    // 如果自己不是模型类, 那就返回自己
